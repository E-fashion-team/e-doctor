...
const PatientCard = () => {
  ...
  useEffect(() => {
    ...
    const allPatients = useSelector((state:RootState)=>state.patient.allPatients)
    console.log("this is the store ",allPatients)
      ...
      {Array.isArray(allPatients) && allPatients.length > 0 ? (
        allPatients.map((patient: any) => (
          ...
          <div key={patient.id} className="card">
            ...
            <image className="img">the image be here</image>
            <span>{patient.name}</span>
            <p className="info">{patient.department}</p>
     <div className="share">  
