      ...
      <div className="container">
        ...
        <form className="contact-us-form-wrapper-all-of-all" ref={formInfo}>
          ...
          <div className="col-12">
            <label htmlFor="inputAddress" className="form-label-wahadha">
              Choose a topic
            </label>
            <select
              name="topic"
            ...
            >
              ...
              <option value="Order Status and Tracking">
              ...
              <option value="Partnership Inquiries">
                Partnership Inquiries
              </option>
              <option value="Press and Media Inquiries">
                Press and Media Inquiries
              </option>
              <option value="Employment and Careers">
                Employment and Careers
              </option>
              <option value="Privacy and Data Concerns">
                Privacy and Data Concerns
              </option>
              <option value="Marketing and Promotions">
                Marketing and Promotions
              </option>
              <option value="Warranty Claims">Warranty Claims</option>
              <option value="Accessibility and Accommodations">
          ...
          <label htmlFor="floatingTextarea2" className="messageLabel">
            Message
          </label>
          <textarea
            name="message"
          ...
          <div className="col-12">
            <button
              ...
              className="btn btn-primary_y btn-removeHover"
            >
              Submit
            </button>
          </div>
          <div>
            ...
            <div className="search-bottom-container d-flex gap-4 justify-content-center">
              ...
              />
              <button
                className="last-button d-flex align-items-center justify-content-center"
                style={{
                  border: "none",
                  height: "3rem",
                  width: "9rem",
