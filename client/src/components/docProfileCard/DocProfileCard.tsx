...
<div>
  ...
  <input type="radio" name="rating" value="5" id="5"/><label>☆</label>
  <input type="radio" name="rating" value="5" id="4"/><label>☆</label>
  <input type="radio" name="rating" value="5" id="3"/><label>☆</label>
  <input type="radio" name="rating" value="5" id="2"/><label>☆</label>
  <input type="radio" name="rating" value="5" id="1"/><label>☆</label>
