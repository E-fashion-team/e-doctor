...
const TeamMember = ({ doctor }: prpos) => {
  return (
    <div
      style={{ width: "25rem" }}
      className="card-service-container d-flex flex-column align-items-center  gap-3"
    >
      ...
      <p style={{ color: "#555", fontWeight: "400", fontSize: "1rem" }}>
        ...
        totam vel blanditiis? Aliquid sapiente eos, aut molestiae expedita,
        consequatur eum saepe obcaecati blan ditiis non perferendis, illo qui
        iusto vitae.
      </p>
    </div>
  );
